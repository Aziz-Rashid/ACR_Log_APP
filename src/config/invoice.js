...
{{#each dets}}
<tr>
<td style="">{{this.item}}</td>
<td><span>$</span>{{this.price}}</td>
</tr>
{{/each}}
{{#if tonu}}
<tr>
<td style="">TONU</td>
<td><span>$</span>{{tonuVal}}</td>
</tr>
{{/if}}
</table>
</div>
